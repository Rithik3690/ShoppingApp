...
public class Animations {
    ...
    public static func slideFromTop(_ view: UIView, fromY: CGFloat = App.mainHeight, delay: CGFloat = 0, duration: CGFloat = 0.5, yPosition: CGFloat = 0, usingSpringWithDamping: CGFloat = 1, initialSpringVelocity: CGFloat = 1, completion: (() -> ())? = nil) {
    ...
    public static func slideUp(_ view: UIView, toY: CGFloat = App.mainHeight, delay: CGFloat = 0, duration: CGFloat = 0.5, usingSpringWithDamping: CGFloat = 1, initialSpringVelocity: CGFloat = 1, completion: (() -> ())?) {
        UIView.animate(withDuration: TimeInterval(duration), delay: TimeInterval(delay), usingSpringWithDamping: usingSpringWithDamping, initialSpringVelocity: initialSpringVelocity, options: .curveEaseInOut, animations: {
            view.alpha = 0
